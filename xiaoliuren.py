...
a = raw_input('请输入日期，格式为yyyy-mm-dd hour，使用当前时间，请直接回车 \n')
if a == '':
	cday = time.localtime()
else:
...
if liuren_day == 1:
	print "农历" + str(lunar.lunarDay) + "日 -- " + "大安日"
elif liuren_day == 2:
	print "农历" + str(lunar.lunarDay) + "日 -- " + "留连日"
elif liuren_day == 3:
	print "农历" + str(lunar.lunarDay) + "日 -- " + "速喜日"
elif liuren_day == 4:
	print "农历" + str(lunar.lunarDay) + "日 -- ""赤口日"
elif liuren_day == 5:
	print "农历" + str(lunar.lunarDay) + "日 -- ""小吉日"
elif liuren_day == 0:
